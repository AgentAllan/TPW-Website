...
$(document).ready(function() {
    ...
    $("#dragonic-carousel").swiperight(function() {
        ...
        $("#model-feats").find("li");
        e.text("The Phoenix Warrior: " + $(this).find("#item-name-caption").text()), l.text($(this).find("#item-price-caption").text()), t.attr("src", a.attr("src"))
    ...
    var e = $(window).width();
    e >= 300 && e <= 1024 ? ($("#item-1, #item-2, #item-3").removeClass("col-sm-3 col-xs-5").addClass("col-sm-5 col-xs-12"), $("#features-item").removeClass("col-md-3").addClass("col-md-6"), $("#item-3").removeClass("col-sm-offset-1").addClass("col-sm-offset-3"), $("#item-2").removeClass("col-xs-offset-2").addClass("col-xs-offset-0")) : ($("#item-1, #item-2, #item-3").removeClass("col-sm-5 col-xs-12").addClass("col-sm-4 col-xs-5"), $("#features-item").removeClass("col-md-6").addClass("col-md-3"), $("#item-3").removeClass("col-sm-offset-3").addClass("col-sm-offset-1"), $("#item-2").removeClass("col-xs-offset-0").addClass("col-xs-offset-2"))
